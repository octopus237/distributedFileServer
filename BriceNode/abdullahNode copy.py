...
if __name__ == "__main__":
    ...
    t1 = ThreadedServer(AbdullahNode, hostname=abdullahNodeConfig.nodeHost, port=abdullahNodeConfig.nodePort, authenticator=authenticator, protocol_config={'allow_public_attrs': True})
